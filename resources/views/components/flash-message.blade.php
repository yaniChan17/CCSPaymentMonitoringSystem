...
@if (session('success') || session('error') || session('info') || session('warning'))
    <div x-data="{ show: true }" 
        ...
        @if (session('success'))
            <div class="bg-white border-l-4 border-green-500 shadow-lg rounded-lg p-4 flex items-start space-x-3">
        ...
        @if (session('error'))
            <div class="bg-white border-l-4 border-red-500 shadow-lg rounded-lg p-4 flex items-start space-x-3">
                <div class="flex-shrink-0">
        ...
        @if (session('info'))
            <div class="bg-white border-l-4 border-blue-500 shadow-lg rounded-lg p-4 flex items-start space-x-3">
                <div class="flex-shrink-0">
        ...
        @if (session('warning'))
            <div class="bg-white border-l-4 border-yellow-500 shadow-lg rounded-lg p-4 flex items-start space-x-3">
                <div class="flex-shrink-0">
