...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>CCS Payment Monitoring System</title>
    ...
    <body class="bg-gray-50 dark:bg-gray-900">
        <!-- Navigation -->
        <nav class="fixed w-full bg-white/90 dark:bg-gray-900/90 backdrop-blur-md shadow-sm z-50">
        ...
        <!-- Hero Section -->
        <div class="hero-pattern relative overflow-hidden pt-24">
                                ...
                                <div class="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <p class="text-xs text-gray-500">BSCS-2024-00123</p>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <p class="text-xs text-gray-500">BSIT-2024-00156</p>
                                        </div>
                                    </div>
                                    <span class="text-blue-600 font-bold">₱3,500</span>
                                </div>
                                <div class="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 bg-yellow-500 rounded-full flex items-center justify-center text-white font-bold">₱</div>
                                        <div class="ml-3">
                                            <p class="text-sm font-medium text-gray-900">Balance Due</p>
                                            <p class="text-xs text-gray-500">BSIS-2024-00178</p>
                                        </div>
                                    </div>
                                    <span class="text-yellow-600 font-bold">₱2,000</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="py-20 bg-white dark:bg-gray-800">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <!-- Feature 2 -->
                    <div class="card-hover p-8 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                    ...
                    <!-- Feature 3 -->
                    <div class="card-hover p-8 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                    ...
                    <!-- Feature 4 -->
                    <div class="card-hover p-8 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                    ...
                    <!-- Feature 5 -->
                    <div class="card-hover p-8 bg-gradient-to-br from-red-50 to-pink-50 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                    ...
                    <!-- Feature 6 -->
                    <div class="card-hover p-8 bg-gradient-to-br from-teal-50 to-green-50 dark:from-gray-700 dark:to-gray-600 rounded-xl">
                ...
                <div class="grid md:grid-cols-4 gap-8">
                    <div class="col-span-2">
                        ...
                        <p class="text-sm text-gray-400 mb-4">
                            Modern payment monitoring system built with Laravel. Designed for educational institutions to efficiently manage student payments.
                        </p>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            ...
                            <li><a href="{{ route('register') }}" class="hover:text-indigo-400 transition">Register</a></li>
                            @auth
                                <li><a href="{{ url('/dashboard') }}" class="hover:text-indigo-400 transition">Dashboard</a></li>
                            @endauth
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li class="text-gray-400">Laravel {{ app()->version() }}</li>
                            <li class="text-gray-400">PHP {{ phpversion() }}</li>
                            <li class="text-gray-400">© {{ date('Y') }} CCS Payment</li>
                        </ul>
                    </div>
                </div>
                <div class="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-500">
                    <p>Built with ❤️ using Laravel & Tailwind CSS</p>
                </div>
            </div>
        </footer>
    </body>
