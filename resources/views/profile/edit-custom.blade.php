    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Manage your personal information</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="year_level" 
                                ...
                                <option value="1st Year" {{ old('year_level', $isStudent && $student ? $student->year_level : $user->year_level) === '1st Year' ? 'selected' : '' }}>1st Year</option>
                                <option value="2nd Year" {{ old('year_level', $isStudent && $student ? $student->year_level : $user->year_level) === '2nd Year' ? 'selected' : '' }}>2nd Year</option>
                                <option value="3rd Year" {{ old('year_level', $isStudent && $student ? $student->year_level : $user->year_level) === '3rd Year' ? 'selected' : '' }}>3rd Year</option>
                                <option value="4th Year" {{ old('year_level', $isStudent && $student ? $student->year_level : $user->year_level) === '4th Year' ? 'selected' : '' }}>4th Year</option>
                            </select>
                            @error('year_level')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
