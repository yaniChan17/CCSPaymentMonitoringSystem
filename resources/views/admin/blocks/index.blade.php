<x-sidebar-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Block Management</h1>
                <p class="mt-1 text-sm text-gray-600">Manage class blocks and assignments</p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-3xl font-bold text-gray-900">{{ $stats['total_blocks'] }}</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600">With Treasurers</p>
                        <p class="mt-2 text-3xl font-bold text-gray-900">{{ $stats['blocks_with_treasurers'] }}</p>
                    </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Block Name</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($blocks as $block)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-600">{{ $block->description ?? 'No description' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-semibold text-gray-900">{{ $block->users_count }} users</div>
                                </td>
                            ...
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 text-lg font-medium">No blocks found</p>
                                        <p class="text-gray-400 text-sm mt-1">Create your first block to get started</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
